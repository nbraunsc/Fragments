...
step_size = 0.001
mol = gto.Mole()
mol.atom = [['C', [1.53371, -0.42208, 0.00795]], ['C', [0.48841, 0.65027, -0.23351]], ['C', [-0.95457, 0.23673, 0.03336]], ['O', [2.71181, -0.09054, 0.12791]], ['H', [0.73137, 1.49653, 0.42043]], ['H', [0.5847, 0.98117, -1.26925]], ['H', [-1.27533, -0.54898, -0.66018]], ['H', [-1.08259, -0.13815, 1.05319]], ['H', [-1.62495, 1.08833, -0.09999]], ['H', [1.2241019333333334, -1.4645096666666666, -0.015575733333333336]]]
mol.basis = 'sto-3g'
mol.build()
...
print('gradient =', g)
print('hessian =', h)
np.save(os.path.join('11', 'fragment11.pye.npy'), e)
np.save(os.path.join('11', 'fragment11.pyg.npy'), g)
np.save(os.path.join('11', 'fragment11.pyh.npy'), h)
